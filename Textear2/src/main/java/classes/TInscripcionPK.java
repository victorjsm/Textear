 ...
 */
@Embeddable
public class TInscripcionPK implements Serializable {
    ...
    public TInscripcionPK() {
    }

    public TInscripcionPK(String rifEmpresa, String telefono, String nombre) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TInscripcionPK)) {
            return false;
        }
        TInscripcionPK other = (TInscripcionPK) object;
