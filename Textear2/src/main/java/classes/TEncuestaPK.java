 ...
 */
@Embeddable
public class TEncuestaPK implements Serializable {
    ...
    public TEncuestaPK(String rifEmpresa, String telefono, String nombre) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TEncuestaPK)) {
            return false;
        }
        TEncuestaPK other = (TEncuestaPK) object;
