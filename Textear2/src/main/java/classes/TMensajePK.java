 ...
 */
@Embeddable
public class TMensajePK implements Serializable {
    ...
    public TMensajePK(String rifEmpresa, String telefono, String nombre) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TMensajePK)) {
            return false;
        }
        TMensajePK other = (TMensajePK) object;
