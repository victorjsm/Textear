 ...
 */
@Embeddable
public class TSistemaPK implements Serializable {
    ...
    public TSistemaPK(String rifEmpresa, String telefono, String nombre) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TSistemaPK)) {
            return false;
        }
        TSistemaPK other = (TSistemaPK) object;
