 ...
 */
@Embeddable
public class MensajeEnvPK implements Serializable {
    ...
    public MensajeEnvPK(String acronimo, String clave, String telefono) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MensajeEnvPK)) {
            return false;
        }
        MensajeEnvPK other = (MensajeEnvPK) object;
