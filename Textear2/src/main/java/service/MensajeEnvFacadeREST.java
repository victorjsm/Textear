...
import classes.MensajeEnv;
import classes.MensajeEnvPK;
 ...
 */
@Stateless
@Path("classes.mensajeenv")
public class MensajeEnvFacadeREST extends AbstractFacade<MensajeEnv> {

    @PersistenceContext(unitName = "com.mycompany_Textear2_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    private MensajeEnvPK getPrimaryKey(PathSegment pathSegment) {
        /*
         ...
         */
        classes.MensajeEnvPK key = new classes.MensajeEnvPK();
    ...
    public MensajeEnvFacadeREST() {
        super(MensajeEnv.class);
    }

    // OBTENER MENSAJES
    // Procedimiento por el cual el REST recibe el Acronimo de una empresa en particular,
    // y retorna todos los mensaes enviados de empresa.
    ...
    public String find_mensajes(@PathParam("acro") String acro) {
        ...
        List<MensajeEnv> temp = super.findWithQuery(
                "SELECT m FROM MensajeEnv m WHERE m.mensajeEnvPK.acronimo = \"" + acro + "\" ");
    ...
    public String delete_mensajes(String temp) {
        ...
        try {
            ...
            for (int i = 0; i < arreglo.length(); ++i) {
                ...
                MensajeEnvPK menpk = new MensajeEnvPK();
