...
app.controller('InscripcionController', [
    ...
    function ($scope, $localStorage, $resource, $http, $q,
        ...
        tinscripcionGET.query({rif: $localStorage.currentUser.empresa.rif})
        ...
        $scope.InvCreateModal = function (abonados, grupos, bandejas, canales) {
            ...
            ModalService.showModal({
                templateUrl: "views/Modal/CreateModals/TareaInscripcionModal.html",
                controller: "ModalCreateTinscripcionController",
                inputs: {
                    abonados: abonados,
                    grupos: grupos,
                    bandejas: bandejas,
        ...
        $scope.InvEditModal = function (tarea, abonados, grupos, bandejas, canales) {
            ...
            ModalService.showModal({
                templateUrl: "views/Modal/EditModals/TareaInscripcionModal.html",
                controller: "ModalEditTinscripcionController",
                inputs: {
                    tarea: tarea,
                    abonados: abonados,
                    grupos: grupos,
        ...
        function editarTareaAbonados(NuevosAbonados, contenido, ViejosAbonados) {
            $scope.loading = true;
            var temp = new tinscripcionEditPOST({
                arreglo: [],
                mensaje: contenido
            });
            var mensaje;
